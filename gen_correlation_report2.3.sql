--@C:\Users\user\OneDrive\Documents\script\gen_correlation_report2.3.sql
...
SPOOL C:\INTEL\TMP\Correlation_Report2.3.csv
...
--~--~AND ROWNUM < 60
--~/
SELECT '"Ticker A","Ticker B","Corr","Corr 12 mth","Corr 6 mth","Corr 3 mth","Corr 2 mth","Corr 1 mth"' title
FROM  DUAL;
SELECT '"' || a.ticker
||'","'|| b.ticker
||'","'|| ROUND(pa_zfcc_09.get_corr(a.ticker, b.ticker), 3) --get_corr
